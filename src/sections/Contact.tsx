    ...
    <div className=" container">
      <div className=" bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center relative overflow-hidden z-0 md:text-left">
        ...
        <div className=" flex flex-col md:flex-row gap-8 md:gap-16 items-center">
          ...
          <div>
            <Link href='mailto:contact@nomanshah.pro'>
            <button className=" text-white bg-gray-900 inline-flex items-center px-6 h-12 rounded-xl gap-2 w-max border border-gray-900 animate-bounce [animation-duration:2s]">
